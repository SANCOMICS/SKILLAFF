...
function RegisterPage() {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      const response = await register({ ...values, password: randomPassword, tokenInvitation });
    ...
    /* @__PURE__ */ jsxs(
      Form,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(Form.Item, { name: "password", style: { display: "none" }, children: /* @__PURE__ */ jsx(Input, { type: "password" }) }),
